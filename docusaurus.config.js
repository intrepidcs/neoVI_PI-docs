...
const config = {
  title: 'neoVI PI',
  tagline: 'Robust and Open Raspberry PI 4 Platform for Automotive',
    ...
    [
      ...
      ({
        docs: {
          ...
          routeBasePath: '/',
          editUrl:
            'https://github.com/intrepidcs/neoVI_PI-docs/blob/main/',
        },
        // blog: {
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/neovi-api-social-card.jpg',
      navbar: {
        title: 'neoVI PI',
        logo: {
          alt: 'neoVI PI Logo',
        ...
        items: [
          ...
          {
            href: 'https://github.com/intrepidcs/neoVI_PI-docs',
            label: 'GitHub',
            position: 'right',
          },
        ],
