...
description: neoVI PI Introduction and Overview
keywords: [neoVI PI, Open Raspberry PI, Introduction and Overview ]
sidebar_position: 4
...
#### 3.3.1 Vehicle Network Interfacing
...
#### 3.3.3 Simulation and Scripting
...
**3.4.1 Construction, Controls and Cabling**
...
**3.4.3 Network Interfaces and Features**
