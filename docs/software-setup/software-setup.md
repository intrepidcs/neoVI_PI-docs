...
3. All required dependencies for controlling the membrane using python: [membrane example for python](/control-membrane-leds-and-trigger-button)
...
<DownloadBox fileName="install_script.zip" fileSize="2KB" filePath="downloads/install_script.zip" />
...
If you see <span class="custom-link">`"Licensing error! Please place a valid license in /home/pi/.vspyx/Licenses"`</span> then the installation was successful.
